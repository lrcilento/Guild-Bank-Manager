...
def render():
    ...
    councilFrame.grid(row = 1, column = 0, rowspan = 2)
    councilListBox = tk.Listbox(councilFrame, selectmode=tk.SINGLE, width = 30, height = 6)
    council = getCouncil()
    indexaux = 0
    for counselor in council:
        councilListBox.insert(indexaux, counselor[1] + " (" + counselor[0] + " - " + str(int(counselor[2]*100)) + "%)")
        indexaux =+ 1
    councilListBox.grid(row = 0, column = 0, padx = 18, pady = 9, columnspan = 3)
    councilListBox.config(state = tk.DISABLED)
    councilNameLabel = tk.Label(councilFrame, text = "Nome:")
    councilNameLabel.grid(row = 1, column = 0, columnspan = 2)
    councilName = tk.StringVar()
    councilNameEntry = tk.Entry(councilFrame, textvariable = councilName)
    councilNameEntry.grid(row = 2, column = 0, columnspan = 2)
    ...
    for rank in ranks:
        ...
        indexaux += 1
    councilRanksListBox.grid(row = 1, column = 2, rowspan = 2, padx = 7, pady = 4)
    ...
    deleteCouncilButton.grid(row = 3, column = 0, padx = 5, pady = 5)
    ...
    updateCouncilButton.grid(row = 3, column = 1, padx = 5, pady = 5)
    ...
    updateRankButton.grid(row = 3, column = 1, padx = 5, pady = 5)
